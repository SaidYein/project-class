...
pairsByIndexRaw = pairsByIndexRaw.filter(x => x=!!x && x.length==2 );

for(i=0; i<pairsByIndexRaw.length; i++){
pairsByIndexRaw[i].splice(0,2,students[pairsByIndexRaw[i][0]], mentors[pairsByIndexRaw[i][1]])
}
